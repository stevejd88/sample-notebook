...
const NavigationBar = ({ auth: { isAuthenticated, loading }, logout }) => {
  const authLinks = (
    <Navbar.Collapse id='responsive-navbar-nav'>
      <Nav className='mr-auto'>
        <Nav.Item>
          <Nav.Link eventKey='2' as={Link} className='nav-link' to='/dashboard'>
            <i className='fas fa-user'></i>{" "}
            <span className='main-nav-link'>Dashboard</span>
          </Nav.Link>
        </Nav.Item>
      </Nav>
      <Nav>
        <Nav.Item>
          <Nav.Link eventKey='3' as={Link} className='nav-link' to='#!'>
            <i className='fas fa-sign-out-alt'></i>{" "}
            <span className='main-nav-link' onClick={logout} href='#!'>
              Logout
            </span>
          </Nav.Link>
        </Nav.Item>
  ...
  const guestLinks = (
    <Navbar.Collapse id='responsive-navbar-nav'>
      <Nav className='mr-auto'>
        <Nav.Item>
          <Nav.Link eventKey='2' as={Link} className='nav-link' to='/register'>
            <i className='fas fa-user-plus'></i>{" "}
            <span className='main-nav-link'>Register</span>
          </Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey='3' as={Link} className='nav-link' to='/contact'>
            <i className='fas fa-link'></i>{" "}
            <span className='main-nav-link'>Contact Us</span>
          </Nav.Link>
        </Nav.Item>
      </Nav>
      <Nav>
        <Nav.Item>
          <Nav.Link eventKey='4' as={Link} className='nav-link' to='/login'>
            <i className='fas fa-sign-in-alt'></i>{" "}
            <span className='main-nav-link'>Login</span>
          </Nav.Link>
        </Nav.Item>
      </Nav>
    </Navbar.Collapse>
          ...
          <Nav>
            <Nav.Item>
              <Nav.Link eventKey='1' as={Link} to='/'>
                ...
                <span className='brand-name'>Starbase Austin</span>
              </Nav.Link>
            </Nav.Item>
          </Nav>
        </Navbar.Brand>
