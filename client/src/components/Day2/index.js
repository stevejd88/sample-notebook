...
const LaunchMass = lazy(() => import("./LaunchMass"));
const LaunchMassGraph = lazy(() => import("./LaunchMassGraph"));
const LaunchDisplacement = lazy(() => import("./LaunchDisplacement"));
const LaunchDisplacementGraph = lazy(() => import("./LaunchDisplacementGraph"));
const Newtons = lazy(() => import("./Newtons"));
const LittleBits = lazy(() => import("./LittleBits"));
const LittleChallenge = lazy(() => import("./LittleChallenge"));
const LittleDrawing = lazy(() => import("./LittleDrawing"));
