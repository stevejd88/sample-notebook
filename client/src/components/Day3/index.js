...
import SoundEnergy from "./SoundEnergy";
import MechEnergy from "./MechEnergy";
import ElecEnergy from "./ElecEnergy";
import LightEnergy from "./LightEnergy";
import ThermalEnergy from "./ThermalEnergy";
      ...
      <Navbar className='days-nav'>
        <Nav className='mr-auto'>
          <NavDropdown title='Activities' className='day3-nav-dropdown'>
            ...
            <Link to={`${match.url}/thermal-energy`} className='btn btn-light'>
              Thermal Energy
            </Link>
